...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0f4ff] to-[#ffffff] dark:from-[#111] dark:to-[#222] relative">
      ...
      >
        <Button
          asChild
          className="rounded-full bg-gradient-to-br from-gray-100 to-gray-300 dark:from-[#444] dark:to-[#222] text-black dark:text-white px-6 py-2 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 font-medium"
        >
          <a 
            href="https://zechao-guan.github.io/" 
            target="_blank" 
